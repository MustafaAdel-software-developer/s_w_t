...
const getProductHTMLRow = (p) => {
  ...
  <tr>
    ...
    <td class="align-middle">
        <div class="input-group quantity mx-auto" style="width: 100px;">
            <div class="input-group-btn">
                <button type="button" class="btn btn-sm btn-primary btn-minus" onclick='new CartLine(${JSON.stringify(
                  p.product
                )}).decQuantity()'>
            ...
            <div class="input-group-btn">
                <button type="button" class="btn btn-sm btn-primary btn-plus" onclick='new CartLine(${JSON.stringify(
                  p.product
                )}).incQuantity()'>
    ...
    <td class="align-middle"><button class="btn btn-sm btn-danger" type="button" onclick='new CartLine(${JSON.stringify(
      p.product
    )}).remove()'><i class="fa fa-times"></i></button></td>
</tr>`;
};
